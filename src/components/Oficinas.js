...
const Oficinas = () => {
  return (
    <div>
      ...
      <div className="fotos">
        <img justify-content="center" width="400px" src={foto1} alt= 'oficina comunitária'/>
        <img justify-content="center" width="400px" src={foto2} alt= 'oficina comunitária'/>
        <img justify-content="center" width="400px" src={foto3} alt= 'oficina comunitária'/>
        <img justify-content="center" width="400px" src={foto4} alt= 'oficina comunitária'/>
        <img justify-content="center" width="400px" src={foto5} alt= 'oficina comunitária'/>
        <img justify-content="center" width="400px" src={foto6} alt= 'oficina comunitária'/>
        </div>
    </div>
